...
let rendered = renderer.image { ctx in
    ...
    // Add your code here
    let secondPostion = rect.offsetBy(dx: 0, dy: 400)
    ...
    let secondString = NSAttributedString(string: secondText, attributes: secondAttr)
    secondString.draw(in: secondPostion)
}
